...
description: >-
  将 OpenClaw 对话路由到最佳中文大模型（DeepSeek/Qwen/GLM/Kimi/Doubao/MiniMax/Step/Baichuan/Spark/Hunyuan），
  无需复杂配置即可切换模型。触发词：'list models'、'use <model>'、'compare <models>'、'哪个中文模型最适合编程/长文本/视觉，切换到它'。
  当用户询问中文模型选择、切换或比较能力与价格时使用。
---
